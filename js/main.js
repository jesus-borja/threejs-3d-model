...
function init() {
    ...
    scene.fog = new THREE.Fog(0x774991, 400, 1000);

    const hemiLight = new THREE.HemisphereLight(0xff00ff, 0x444444, 5);
    hemiLight.position.set(0, 200, 0);
    scene.add(hemiLight);

    const dirLight = new THREE.DirectionalLight(0x00ff00, 5);
